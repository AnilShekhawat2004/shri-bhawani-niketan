...
//             onClick={onClick}
//             type={type}
//             className={`relative group flex flex-row justify-center items-center gap-2 h-[50px] border-[#a41e34] border-[1px] 
//                         pt-3 pb-3 pl-2 pr-4 transition-all duration-[1s] hover:text-white min-w-[200px]
//                         ${className}`} // Allow external styling
//         >
//             <span className="absolute z-10 text-[15px] w-0 h-full left-0 bg-[#a41e34] 
//                   transition-all duration-[1s] group-hover:w-full "></span>

//             <span className="absolute z-20 font-semibold transition-all duration-500 ease-in-out
