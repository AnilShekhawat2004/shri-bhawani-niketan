...
//   return (
//     <div className={`flex font-helvetica flex-row bg-white w-full h-[0.2px] lg:translate-y-[110px] ${className}`}>
//       <div className="border-white border-r-[0.5px] w-[40px] h-[145px]" />

//       {hoverItems.map((item) => (
//         <Link
//           to={item.link}
//           key={item.id}
//           className="group relative flex flex-col justify-center items-center border-white border-r-[0.5px] w-[365px] h-[144.2px]"
//         >
//           <span
//             className={`absolute z-10 left-0 top-0 -translate-y-[55px] h-1 w-0 transition-all duration-700 group-hover:w-[365px] ${item.color}`}
//           ></span>

//           <img
//             src={item.img}
//             alt={`Hover ${item.id}`}
//             className="opacity-0 object-cover ease-in-out transition-all duration-[1s] group-hover:opacity-100 absolute h-[200px] w-[365px] -translate-y-[27px]"
//           />

//           <div className="flex flex-col justify-center items-center gap-2">
//             <div className="flex flex-col justify-center items-center group-hover:-translate-y-10 transition-all duration-500">
//               <p
//                 className={`absolute -translate-y-5 z-10 text-[13px] uppercase w-[180px] text-center ${item.color} ${item.textColor}`}
//               >
//                 {item.topText}
//               </p>
//               <p className="absolute translate-y-5 text-[30px] whitespace-nowrap">
//                 {item.bottomText}
//               </p>
//             </div>

//             <p className="absolute opacity-0 translate-y-5 leading-tight text-center text-[15px] group-hover:opacity-100 delay-150 transition-all duration-500">
//               {item.desc}
//             </p>
//           </div>
//         </Link>
...
function BottomSection({ className }) {
  return (
    <div className={`flex flex-col lg:flex-row font-helvetica bg-white w-full lg:h-[0.2px] lg:translate-y-[110px] ${className}`}>
