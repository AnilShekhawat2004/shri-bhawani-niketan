    ...
    <div className="relative mt-32 lg:h-[600px] md:h-[500px] h-[400px] group">
      ...
      >
        <div className="flex flex-col lg:group-hover:-translate-y-24 lg:ml-0 ml-48 transition-all duration-[1s] delay-150">
          <p className="text-[17px] lg:ml-0 ml-2 lg:-translate-x-[45px] lg:translate-y-[85px]">
            Lock In Your Place
          </p>
        ...
        <p
          className="text-[21px] w-[600px] translate-x-[50px] absolute opacity-0 leading-tight translate-y-[110px]
        ...
        <Link
          to={"/apply"}
          className="lg:-translate-x-[152px] lg:translate-y-[100px] text-[17px]"
        >
          <RButton
