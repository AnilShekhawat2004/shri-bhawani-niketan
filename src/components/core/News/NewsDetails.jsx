      ...
      <div className="mt-32 w-[85%] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="flex-1 flex flex-col gap-5">
            <p className="text-bhawaniDark font-bold font-m1 text-[50px]">
              {newsData.newsName}
            </p>
            ...
            <img
              ...
              alt="News"
              loading="lazy"
              className="w-full lg:h-[500px] rounded-3xl object-cover"
            />

            <p className="font-verdana text-[20px] mt-5">
          ...
          <div className="lg:w-[30%] flex flex-col gap-6">
            <h3 className="text-bhawaniDark text-[28px] font-bold mb-4">
              Recent News
            </h3>
            {recentData.map((news) => (
              <Link
