        ...
        <div className="">
            <div>
                ...
                <div className="mt-32 w-[80%] mx-auto">
                    ...
                    />
                    {/* <img src={King2} className="w-[380px] translate-x-[113px] h-[400px]"></img> */}
                    <CommonCard
                        position="right"
                        LineImage={King2}
                ...
                <div className="mt-[250px] flex flex-col gap-[70px]">
                   <div className="flex flex-col items-center">
                       <p className="text-center text-[50px] font-m1 font-bold text-bhawaniDark">Voices That Shape Futures</p>
