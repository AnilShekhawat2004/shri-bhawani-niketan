    ...
    return(
        <div>
            <div>
                ...
                <RedBar className="absolute font-m1"
            ...
            <div className="mt-32 w-[80%] mx-auto">
                <div className="flex flex-col gap-6 justify-center items-center">
                    <p className="text-[50px] font-verdana text-center font-extrabold text-bhawaniDark">Your Future is Here</p>
                    <p className="font-verdana text-center text-[20px] w-[550px]">For over 75 years, Shri Bhawani Niketan College 
                    has been dedicated to nurturing excellence in education and character. Our committed faculty and staff create an inspiring 
                    environment for students to thrive. Discover exciting career opportunities and become a part of our growing legacy today.</p>
                </div>
                ...
                <div className="mt-32 flex flex-row items-center justify-center gap-10">
                    ...
                    <div className="w-[550px] shadow-xl h-[400px] bg-bhawaniLight flex flex-col justify-center items-center gap-10">
                        <p className="text-bhawaniDark font-bold text-[35px] font-verdana">A Community That Cares </p>
                        <p className="w-[400px] font-verdana text-center text-[18px]">Shri Bhawani Niketan College fosters a 
                        supportive, respectful community where 
                        employees are valued, empowered, and 
                        inspired to grow personally and professionally 
                        every day</p>
                    </div>
                </div>

                <div className="mt-32 bg-bhawaniDark text-white flex flex-col justify-center items-center gap-5 pt-6 pb-6">
                    <p className="font-verdana font-bold text-[40px] ">Your Path to Joining Us Starts Here</p>
