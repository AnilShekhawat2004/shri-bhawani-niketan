    ...
    return(
        <div>
            ...
            <div className="w-[80%] mx-auto mt-32">
                <div>
                    <p className="text-[50px] font-m1 font-extrabold text-bhawaniDark">Bhawani Events</p>
                </div>
                ...
                <div className="mt-10">
                  {Object.entries(groupedBranch).map(([branch, event]) => (
                    <div key={branch} className="">
                        <div className="mt-20">
                            <p className="text-[40px] font-bold font-m1 text-bhawaniDark translate-x-8">{branch}</p>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            {event.map(events => (
                                ...
                                >
                                    ...
                                    <div className="absolute bg-bhawaniDark w-[80px] h-[70px] rounded-br-2xl flex flex-col 
                                    justify-center items-center group-hover:bg-bhawaniPink transition-all duration-500">
                                        <p className="text-white text-[25px] font-bold font-helvetica">{events.day}</p>
                                        <p className="text-white font-helvetica">{events.date}</p>
                                    </div>
                                    <div className="absolute mt-[225px] ml-2">
                                        <p className="text-[22px] font-semibold font-m2 group-hover:text-bhawaniRed">{events.name}</p>
                                        <p className="mt-1 group-hover:text-bhawaniRed">{events.description}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
