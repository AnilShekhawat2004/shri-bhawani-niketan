...
exports.editSection = async(req, res) => {
    try{
        ...
        const updatedSection = await teacherSection.findOne({
            _id: sectionId
        })
        .populate({
            path: "teachCat",
...
exports.getAllSection = async(req, res) => {
    try{
        const allSection = await teacherSection.find().select("name designation image teachCat");
...
exports.getTeachDetails = async(req, res) => {
    try{
        ...
        const teachDetails = await teacherSection.findOne({
            _id: teachId
        }).populate("SubSection").populate("teachCat").exec()
