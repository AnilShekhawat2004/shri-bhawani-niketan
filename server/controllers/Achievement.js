    ...
    try{
        ...
        if(
            ...
            return res.status(404).json({
                success: false,
                message:"All fields are required to fill in order to create a Achievement",
            })
        }
...
exports.deleteAchieve = async (req, res) => {
    try {
        const achieveId = req.body.achieveId || req.params.achieveId || req.query.achieveId;
...
exports.editAchievement = async(req, res) => {
    try{
        const{achieveId, title, descritption} = req.body
